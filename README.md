# CI Runners
This repository contains the source used to create the [Runners] for CI.
To build a VM machine from this repo's source, see the [instructions](./help/CreateImageAndAzureResources.md).
